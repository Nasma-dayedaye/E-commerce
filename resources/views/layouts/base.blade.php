								...
								@auth
									...
									<li class="menu-item menu-item-has-children parent" >
										...
										<ul class="submenu curency" >
											...
											<li class="menu-item" >
												<a title="Categories" href="{{ route('admin.categories') }}">Les Catégories</a>
											</li>
											<li class="menu-item" >
												<a title="Products" href="{{ route('admin.products') }}">Les produits</a>
											</li>
											<li class="menu-item" >
												<a title="All Orders" href="{{ route('admin.orders') }}">Les commandes</a>
											</li>
											<li class="menu-item" >
												<a title="Manage Home Slider" href="{{ route('admin.homeslider') }}">Le curseur d'accueil</a>
											</li>
											<li class="menu-item" >
												<a title="Manage Home Categories" href="{{ route('admin.homecategories') }}">Les catégories d'accueil</a>
											</li>
											<li class="menu-item" >
												<a title="Sale setting" href="{{ route('admin.coupons') }}">Les coupons</a>
											</li>
											<!--<li class="menu-item" >
												<a title="Sale setting" href="{{ route('admin.sale') }}">Paramètre de vente</a>
											</li>-->
											<li class="menu-item" >
												<a title="Contact Message" href="{{ route('admin.contact') }}">Les messages </a>
											</li>
											<li class="menu-item" >
