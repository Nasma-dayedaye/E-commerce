            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" ectype="multipart/form-data" wire:submit.prevent="updateProduct">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <textarea type="form-control" placeholder="Short Description" class="form-control input-md" wire:model="short_description"></textarea>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Galerie des produits</label>
                                <div class="col-md-4">
                                    <input type="file" class="input-file" wire:model="newimage" multiple/>
                                    @if ($newimages)
