    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li href="/contact-us" class="item-link"><span>A propos de nous</span></li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        <!-- <div class="main-content-area"> -->
            <div class="aboutus-info style-center">
                <b class="box-title">Mon akcessoire</b>
                <p class="txt-content">Mon akcessoire s'engage à offrir à ses clients le meilleur service,les plus importantes offres du marché avec un large choix.</p>
            </div>
            ...
            <div class="row equal-container">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="aboutus-box-score equal-elem ">
                        ...
                        <span class="sub-title">Produits</span>
                        <p class="desc">Mon akcessoire vous propose l’assortiment le plus large à un prix imbattable</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="aboutus-box-score equal-elem ">
                        <b class="box-score-title">100%</b>
                        <span class="sub-title">Fournir des produits authentiques</span>
                        <p class="desc">Mon akcessoire est née en réponse à cette problématique et depuis nous nous sommes engagés à offrir à nos clients uniquement des produits authentiques et originaux garantis à 100%</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="aboutus-box-score equal-elem ">
                ...
                <div class="our-staff">
                    <div 
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="LEONA">
                                    <figure><img src="assets/images/member.png" alt="LEONA"></figure>
                                </a>
                            </div>
                            <div class="info">
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="LUCIA">
                                    <figure><img src="assets/images/member.png" alt="LUCIA"></figure>
                                </a>
                            </div>
                            <div class="info">
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="NANA">
                                    <figure><img src="assets/images/member.png" alt="NANA"></figure>
                                </a>
                            </div>
                            <div class="info">
                                <b class="name">NANA</b>
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="BRAUM">
                                    <figure><img src="assets/images/member.png" alt="BRAUM"></figure>
                                </a>
                            </div>
                            <div class="info">
