        ...
        <div class="wrap-product-detail">
            ...
            <div class="detail-info">
                ...
                @if($product->sale_price>0)
                    ...
                    @else
                        <div class="wrap-price"><p class="product-price">{{$product->sale_price}}DH</p></div>
                @endif
                    </div>
                ...
                <div class="advance-info">
                    <div class="tab-control normal">
                        <a href="#description" class="tab-control-item active">Déscription</a>
                        <a href="#add_infomation" class="tab-control-item">Information additionnelle</a>
            ...
            <div class="widget widget-our-services ">
                    ...
                    <ul class="our-services">
                        ...
                        <li class="service">
                            <a class="link-to-service" href="#">
                                ...
                                <div class="right-content">
                                    ...
                                    <span class="subtitle">Sur commande +400 DH</span>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="service">
                            <a class="link-to-service" href="#">
                                ...
                                <div class="right-content">
                                    ...
                                    <span class="subtitle">Obtenez un cadeau!</span>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="service">
                            <a class="link-to-service" href="#">
                                ...
                                <div class="right-content">
                                    <b class="title">Retour de commande</b>
                                    <span class="subtitle">Retour sous 7 jours</span>
                                </div>
                            </a>
                        </li>
                    </ul>
                                ...
                                <li class="product-item">
                                    ...
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            <a href="href=" {{route('product.details',['slug'=>$p_product->slug])}}
                                                class="product-name"><span>{{$p_product->name}}</span></a>
                                            <div class="wrap-price"><span
                                                    class="product-price">{{$p_product->regular_price}}DH</span></div>
                                        </div>
                                    </div>
                                    @endforeach
                                </li>
                ...
                <div class="single-advance-box col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wrap-show-advance-info-box style-1 box-in-site">
                        <h3 class="title-box">Nouveaux produits</h3>
                                ...
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{route('product.details',['slug'=>$r_products->slug])}}"
                                            title="{{$r_products->name}}">
                                            <figure><img
                                                    src="{{ asset('assets/images/products') }}/{{$r_products->image}}"
                                    ...
                                    <div class="product-info">
                                        <a href="{{route('product.details',['slug'=>$r_products->slug])}}"
                                            class="product-name"><span>{{$r_products->name}}</span></a>
                                        <div class="wrap-price"><span
                                                class="product-price">{{$r_products->regular_price}}DH</span></div>
                                    </div>
                                </div>
                                @endforeach
