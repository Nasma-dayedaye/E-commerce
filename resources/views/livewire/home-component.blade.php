<main id="main">
    <div class="container">
            ...
            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true"
                ...
                <div class="item-slide">
                    ...
                    <div class="slide-info slide-1">
                        ...
                        <a href="{{$slide->link}}" class="btn-link">Achetez maintenant</a>
                    </div>
                </div>
                @endforeach
        ...
        <div class="wrap-show-advance-info-box style-1 has-countdown">
            <h3 class="title-box">En soldes</h3>
            <div class="wrap-countdown mercado-countdown" data-expire="2021/10/05 12:34:56"></div>
        ...
        <div class="wrap-show-advance-info-box style-1">
            ...
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img src="{{ asset('assets/images/new2.jpg') }}" width="1170"
        ...
        <div class="wrap-show-advance-info-box style-1">
            ...
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img src="{{ asset('assets/images/nasma.png') }}" width="1170"
                            height="240" alt=""></figure>
                </a>
            </div>
            <div class="wrap-products">
