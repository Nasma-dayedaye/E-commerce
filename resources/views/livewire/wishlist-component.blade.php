    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>Favoris</span></li>
            </ul>
        </div>
        ...
        <div class="row">
                ...
                <li class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ">
                    <div class="product product-style-3 equal-elem ">
                        ...
                        <div class="product-info">
                            ...
                            <a href="#" class="btn add-to-cart" wire:click.prevent="moveProductFromWishlistToCart('{{$item->rowId}}')" >Passer au panier</a>
            ...
            @else
                <h4>Aucun article dans mes favoris</h4>
                @endif
        </div>
